                    ...
                    <div className="flex flex-1 items-center justify-end md:justify-between">
                        <nav aria-label="Global" className="hidden md:block">
                            <ul className="flex items-center gap-6 text-sm">
                                ...
                                <li>
                                    <Link className="text-gray-500 transition hover:text-gray-500/75" to="/careers">
                                        Careers
                                    </Link>
                                </li>

                                <li>
                                    <Link className="text-gray-500 transition hover:text-gray-500/75" to="/history">
                                        History
                                    </Link>
                                </li>
                                ...
                                <li>
                                    <Link className="text-gray-500 transition hover:text-gray-500/75" to="/blogs">
                                        Blog
                                    </Link>
                                </li>
                            </ul>
