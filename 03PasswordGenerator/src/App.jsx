    ...
    <>
      <div className="flex flex-col justify-center text-center">
        ...
        <div className="w-[40%] align-middle mx-auto bg-[#D9D9D990] p-[75px] rounded-[30px]">
          <input
            type="text"
            className="w-full h-[105px] rounded-[20px] bg-[#D9D9D990] text-[32px] focus:outline-none px-[20px]"
            value={password}
            ref={passwordRef}
            readOnly
          />
          <p className="text-start mt-[20px] font-bold text-[24px]">
            Length: {length}
          </p>
          <input
            type="range"
            ...
            value={length}
            max={20}
            className="text-start text-[24px] w-full mt-[20px] accent-[#161C3A]"
            onChange={(e) => {
              setLength(e.target.value);
            }}
          />
          <label className="cursor-pointer label flex align-middle">
            <p className="text-start mt-[20px] font-bold text-[24px] mr-[20px]">
              Characters:
            </p>
            <input
              type="checkbox"
              className="checkbox checkbox-info mt-[20px] w-[20px]"
          ...
          <button
            className="bg-[#2D657F80] text-[32px] py-[20px] px-[70px] rounded-[20px] text-white font-light mt-[20px]"
            onClick={copyPass}
          >
            COPY
          </button>
      ...
      {/* <div className='text-center mt-10'>
        ...
        <div className="mx-auto max-w-xs flex">
          <input type="text" className="block w-[100vw] rounded-2xl border-gray-300 shadow-sm px-5 py-2 text-black rounded-r-none" value={password} ref={passwordRef} readOnly />
